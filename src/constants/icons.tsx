...
export const IconInformation = ({ color = colors.text.quaternary, size = SIZE_ICONS }: IColor): React.JSX.Element => (
  <SVG src={iconInformation} width={size} height={size} fill={color} />
)
